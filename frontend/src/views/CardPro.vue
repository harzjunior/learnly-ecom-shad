<template>
    <div
      ...
      <div class="mt-10 text-center">
        <h2 class="text-3xl font-bold">Sneak Peek of Our Products</h2>
      ...
      <!-- Social Media Links -->
      <div class="social-media-icons flex space-x-4 mt-6">
  ...
  export default {
    setup() {
      ...
      const teaserProducts = [
        { name: 'Product 1', image: 'https://i.etsystatic.com/42678828/r/il/b5bfb4/4878450308/il_600x600.4878450308_lfmv.jpg' },
        { name: 'Product 2', image: 'https://img.freepik.com/premium-photo/cute-cartoon-cat-character-generative-ai_570929-3968.jpg' },
        { name: 'Product 3', image: 'https://img.freepik.com/premium-photo/image-cat-wearing-hoodie-generative-ai_97167-1329.jpg' },
      ];
